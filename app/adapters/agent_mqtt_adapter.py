...
from ..interfaces.agent_gateway import AgentGateway
from ..entities.agent_data import AgentData, GpsData
from ..usecases.data_processing import process_agent_data
...
class AgentMQTTAdapter(AgentGateway):
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            agent_data_json = json.loads(payload)
            agent_data = AgentData.parse_obj(agent_data_json)
            ...
            if not self.hub_gateway.save_data(processed_data):
                logging.error("4_____Hub is not available")
